...
class TravelModal(customtkinter.CTkToplevel):
    def __init__(self, parent, waypoint=None, onConfirm=lambda: {}):
        ...
        self.cityCombobox = customtkinter.CTkComboBox(
            self.frame, values=['AbDendriel', 'Ankrahmun', 'Carlin', 'Darashia', 'Edron', 'Farmine', 'Issavi', 'Kazoordon', 'LibertBay', 'PortHope', 'Rathleton', 'Svargrond', 'Thais', 'Venore', 'Yalahar', 'Tibia', 'Peg Leg', 'shortcut'], **combobox_args)

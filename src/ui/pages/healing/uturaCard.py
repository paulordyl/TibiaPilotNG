...
class UturaCard(customtkinter.CTkFrame):
    def __init__(self, parent, context):
        ...
        self.titleLabel = customtkinter.CTkLabel(self, text='Utura', text_color=MATRIX_GREEN) # Renamed from manaFoodLabel
        ...
        self.manaPercentageGreaterThanOrEqualDescLabel.grid(
            column=0, row=5, sticky='w', padx=10, pady=5) # sticky changed to 'w'

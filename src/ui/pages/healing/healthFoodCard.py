...
class HealthFoodCard(customtkinter.CTkFrame):
    def __init__(self, parent, context):
        ...
        self.titleLabel = customtkinter.CTkLabel(self, text="Health food", text_color=MATRIX_GREEN) # Renamed from healthFoodLabel
        ...
        self.hpLessThanOrEqualSlider.grid(column=1, row=3, sticky='ew', padx=10, pady=5)
